...
In the **style.css** file, add a `comic` class. Don't forget the dot in front of the class name.

## \--- code \---

language: css line_numbers: true line_number_start: 28 line_highlights: 35-37
...
language: css line_numbers: true line_number_start: 35 line_highlights: 36-37

* * *

.comic { color: red; background-color: yellow; }
...
language: html line_numbers: true line_number_start: 11 line_highlights: 14

* * *

<

p> <span class="magazine1 big">Meet</span> <span class="magazine2 big">me</span> <span class="comic big">on</span>
...
Open <http://jumpto.cc/web-fonts>{:target="_blank"} and search for **'bangers'**:
...
language: html line_numbers: true line_number_start: 3 line_highlights: 7-9
...
Switch to your **'style.css'** file and add the font-family code into the comic style:

## \--- code \---

language: css line_numbers: true line_number_start: 35 line_highlights: 38

* * *

.comic { color: red; background-color: yellow; font-family: "Bangers", serif; }
